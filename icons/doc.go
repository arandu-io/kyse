...
// would put all of it in every binary that draws one arrow -- 1.2 MB, measured
...
// # Weight
//
// The regular weight, and only it. Phosphor draws six, and shipping two would
// mean Trash and TrashBold: two names for one idea, and a question on every
